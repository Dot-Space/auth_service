...
func (c *authClient) CheckToken(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	// ======================================= Permissions ==========================================
	// Check if current user token is valid
	CheckToken(context.Context, *CheckRequest) (*CheckResponse, error)
...
func (UnimplementedAuthServer) CheckToken(context.Context, *CheckRequest) (*CheckResponse, error) {
...
func _Auth_CheckToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CheckToken(ctx, req.(*CheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
